...
public class AlbumVideoAdapter extends BaseSongAdapter<AlbumVideoAdapter.ItemHolder> implements BubbleTextGetter {
    ...
    @Override
    public void onBindViewHolder(AlbumVideoAdapter.ItemHolder itemHolder, int i) {
        AlbumVideo localItem = arraylist.get(i);
