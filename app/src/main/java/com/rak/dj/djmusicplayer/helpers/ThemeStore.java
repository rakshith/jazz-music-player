...
public class ThemeStore implements ThemeStorePrefKeys, ThemeStoreInterface {
    ...
    public ThemeStore primaryColorAttr(@AttrRes int colorAttr) {
        return primaryColor(ATEUtils.resolveColor(mContext, colorAttr));
    }
    ...
    public ThemeStore primaryColorDarkAttr(@AttrRes int colorAttr) {
        return primaryColorDark(ATEUtils.resolveColor(mContext, colorAttr));
    }
    ...
    public ThemeStore accentColorAttr(@AttrRes int colorAttr) {
        return accentColor(ATEUtils.resolveColor(mContext, colorAttr));
    }
    ...
    public ThemeStore statusBarColorAttr(@AttrRes int colorAttr) {
        return statusBarColor(ATEUtils.resolveColor(mContext, colorAttr));
    }
    ...
    public ThemeStore navigationBarColorAttr(@AttrRes int colorAttr) {
        return navigationBarColor(ATEUtils.resolveColor(mContext, colorAttr));
    }
    ...
    public ThemeStore textColorPrimaryAttr(@AttrRes int colorAttr) {
        return textColorPrimary(ATEUtils.resolveColor(mContext, colorAttr));
    }
    ...
    public ThemeStore textColorPrimaryInverseAttr(@AttrRes int colorAttr) {
        return textColorPrimaryInverse(ATEUtils.resolveColor(mContext, colorAttr));
    }
    ...
    public ThemeStore textColorSecondaryAttr(@AttrRes int colorAttr) {
        return textColorSecondary(ATEUtils.resolveColor(mContext, colorAttr));
    }
    ...
    public ThemeStore textColorSecondaryInverseAttr(@AttrRes int colorAttr) {
        return textColorSecondaryInverse(ATEUtils.resolveColor(mContext, colorAttr));
    }
    ...
    public static int primaryColor(@NonNull Context context) {
        return prefs(context).getInt(KEY_PRIMARY_COLOR, ATEUtils.resolveColor(context, R.attr.colorPrimary, Color.parseColor("#455A64")));
    }

    @CheckResult
    @ColorInt
    public static int primaryColorDark(@NonNull Context context) {
        return prefs(context).getInt(KEY_PRIMARY_COLOR_DARK, ATEUtils.resolveColor(context, R.attr.colorPrimaryDark, Color.parseColor("#37474F")));
    }
    ...
    public static int textColorPrimary(@NonNull Context context) {
        return prefs(context).getInt(KEY_TEXT_COLOR_PRIMARY, ATEUtils.resolveColor(context, android.R.attr.textColorPrimary));
    }

    @CheckResult
    @ColorInt
    public static int textColorPrimaryInverse(@NonNull Context context) {
        return prefs(context).getInt(KEY_TEXT_COLOR_PRIMARY_INVERSE, ATEUtils.resolveColor(context, android.R.attr.textColorPrimaryInverse));
    }

    @CheckResult
    @ColorInt
    public static int textColorSecondary(@NonNull Context context) {
        return prefs(context).getInt(KEY_TEXT_COLOR_SECONDARY, ATEUtils.resolveColor(context, android.R.attr.textColorSecondary));
    }

    @CheckResult
    @ColorInt
    public static int textColorSecondaryInverse(@NonNull Context context) {
        return prefs(context).getInt(KEY_TEXT_COLOR_SECONDARY_INVERSE, ATEUtils.resolveColor(context, android.R.attr.textColorSecondaryInverse));
    }
