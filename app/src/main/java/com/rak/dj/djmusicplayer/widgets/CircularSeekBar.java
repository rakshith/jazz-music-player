package com.rak.dj.djmusicplayer.widgets;
...
public class CircularSeekBar extends View {
    ...
    private static final float DEFAULT_START_ANGLE = 180f; // Geometric (clockwise, relative to 3 o'clock)
    private static final float DEFAULT_END_ANGLE = 0f; // Geometric (clockwise, relative to 3 o'clock)
