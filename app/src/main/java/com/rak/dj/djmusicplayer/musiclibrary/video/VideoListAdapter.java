...
public class VideoListAdapter extends BaseAdapter<VideoListAdapter.ItemHolder> implements FastScrollRecyclerView.SectionedAdapter {
    ...
    public void onBindViewHolder(VideoListAdapter.ItemHolder itemHolder, int position) {
        ...
        itemHolder.duration.setText(JazzUtil.getReadableDurationString(localItem.duration));
    ...
    public String getSectionName(int position) {
        if (arraylist == null || arraylist.size() == 0)
            return "";
        return Character.toString(arraylist.get(position).title.charAt(0));
    }
