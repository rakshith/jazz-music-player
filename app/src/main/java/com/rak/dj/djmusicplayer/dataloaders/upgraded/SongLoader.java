...
public class SongLoader {
    ...
    public static ArrayList<Song> getMiniSongs(Context context){
        return getSongs(makeSongCursor(context, "duration <= 60000", null));
    }
    ...
    public static Cursor makeSongCursor(@NonNull final Context context, @Nullable final String selection, final String[] selectionValues) {
        return makeSongCursor(context, selection, selectionValues, PreferencesUtils.getInstance(context).getSongSortOrder());
    }
