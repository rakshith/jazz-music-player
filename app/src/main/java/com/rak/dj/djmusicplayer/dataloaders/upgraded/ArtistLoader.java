...
public class ArtistLoader {
    public static String getSongLoaderSortOrder(Context context) {
        return PreferencesUtils.getInstance(context).getArtistSortOrder() + ", " + PreferencesUtils.getInstance(context).getArtistAlbumSortOrder() + ", " + PreferencesUtils.getInstance(context).getAlbumSongSortOrder();
    }
